                  ...
                  <tr key={h.id}>
                    ...
                    <td style={{padding: '10px', border: '1px solid #e2e8f0'}}>
                      <div style={{display: 'flex', gap: '2px', height: '18px', alignItems: 'flex-end', background: '#eee', width: '45px', padding: '2px', borderRadius: '3px'}}>
                        <div style={{background: '#10b981', flex: 1, height: `${(h.profit/(h.profit+h.expenses))*100}%`}}></div>
                        <div style={{background: '#ef4444', flex: 1, height: `${(h.expenses/(h.profit+h.expenses))*100}%`}}></div>
                      </div>
                    </td>
                  </tr>
                ))}
